...
def _build_developer_summary(developer_id: int, db: Session) -> dict:
...
def get_my_standup(
    ...
    summary = _build_developer_summary(current_user.developer_id, db)
    return summary
...
def get_team_standup(
    ...
    for dev in developers:
        summaries.append(_build_developer_summary(dev.id, db))
